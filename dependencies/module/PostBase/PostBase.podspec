...
Pod::Spec.new do |s|
  ...
  s.version  = '0.1.0'
  s.license  = 'MIT'
  s.summary  = 'PostBase aims to be a drop-in replacement for UITabBarController.' 
  s.description = 'PostBase aims to be a drop-in replacement of UITabBarController with the intention of letting developers easily customise its appearance. JBTabBar uses .'
