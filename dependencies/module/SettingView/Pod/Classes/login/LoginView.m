...
- (void)viewDidLoad {
   ...
   UIBarButtonItem * btnLogin = [[UIBarButtonItem alloc] initWithTitle:@"登录"
                                                                 style:UIBarButtonItemStyleBordered
                                                                target:self
                                                                action:@selector(click_Login:)];
...
//               ProfileBase * _parent = (ProfileBase * )
//               [Config Instance].viewBeforeLogin;
...
//            }
      ...
      case 0:
      case -1: {
         [Tool ToastNotification:[NSString stringWithFormat:@"错误 %@", error.errorMessage]
                         andView:self.view
                      andLoading:NO
                     andIsBottom:NO];
      }
